...
// window.addEventListener('click', (e) => console.log(e.target));  // <body> / <div class="item">
// 跳出 modal 后点击 空白处 modal
...
function storeBookmark(e) {
    ...
    // console.log(nameValue, urlValue);  // aaaa https://www.baidu.com
